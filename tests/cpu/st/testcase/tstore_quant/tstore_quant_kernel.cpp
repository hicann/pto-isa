...
template <
    typename Dst, typename SrcT, int gShape0, int gShape1, int gShape2, int gShape3, int gShape4, bool is_v_quant,
    ...
    __gm__ Dst __out__* out, __gm__ SrcT __in__* src, __gm__ uint64_t __in__* fbQuant)
{
    constexpr int gStride[5] = {
        gShape1 * gShape2 * gShape3 * gShape4, gShape2 * gShape3 * gShape4, gShape3 * gShape4, gShape4, 1};
...
template <
    typename DstT, typename SrcT, int gShape0, int gShape1, int gShape2, int gShape3, int gShape4, bool is_v_quant,
    bool saturate_inf, bool apply_relu>
AICORE inline void RunTStoreColMajorQuant(
    __gm__ DstT __out__* out, __gm__ SrcT __in__* src, __gm__ uint64_t __in__* fbQuant)
{
    constexpr int gStride[5] = {
        gShape1 * gShape2 * gShape3 * gShape4, gShape2 * gShape3 * gShape4, gShape3 * gShape4, 1, gShape3};
...
__global__ AICORE void TStoreKernelQuant(__gm__ DstT* out, __gm__ SrcT* src, __gm__ uint64_t* fbQuant)
{
    if constexpr (format == pto::Layout::ND) {
        RunTStoreRowMajorQuant<
            DstT, SrcT, gShape0, gShape1, gShape2, gShape3, gShape4, is_v_quant, saturate_inf, apply_relu>(
            out, src, fbQuant);
        ...
        RunTStoreNZQuant<DstT, SrcT, gShape0, gShape1, gShape2, gShape3, gShape4, is_v_quant, saturate_inf, apply_relu>(
            out, src, fbQuant);
    }
}
...
void LaunchTStoreQuant(DstT* out, SrcT* src, uint64_t* fbQuant, void* stream)
{
    ...
    if constexpr (format == 0) {
        TStoreKernelQuant<
            DstT, SrcT, pto::Layout::ND, gShape0, gShape1, gShape2, gShape3, gShape4, is_v_quant, saturate_inf,
            apply_relu>(static_cast<DT*>(out), static_cast<ST*>(src), fbQuant);
    } else if constexpr (format == 1) {
        TStoreKernelQuant<
            DstT, SrcT, pto::Layout::DN, gShape0, gShape1, gShape2, gShape3, gShape4, is_v_quant, saturate_inf,
            apply_relu>(static_cast<DT*>(out), static_cast<ST*>(src), fbQuant);
    } else if constexpr (format == 2) {
        TStoreKernelQuant<
            DstT, SrcT, pto::Layout::NZ, gShape0, gShape1, gShape2, gShape3, gShape4, is_v_quant, saturate_inf,
            apply_relu>(static_cast<DT*>(out), static_cast<ST*>(src), fbQuant);
    }
}

template void LaunchTStoreQuant<0, int8_t, float, 1, 1, 1, 2, 128, true, true, true>(
    int8_t* out, float* src, uint64_t* fbQuant, void* stream);
template void LaunchTStoreQuant<0, int16_t, int32_t, 1, 2, 1, 23, 121, true, true, false>(
    int16_t* out, int32_t* src, uint64_t* fbQuant, void* stream);
template void LaunchTStoreQuant<0, int8_t, int32_t, 2, 2, 3, 23, 47, true, false, true>(
    int8_t* out, int32_t* src, uint64_t* fbQuant, void* stream);
template void LaunchTStoreQuant<1, aclFloat16, float, 1, 1, 1, 4, 21, false, true, true>(
    aclFloat16* out, float* src, uint64_t* fbQuant, void* stream);
template void LaunchTStoreQuant<1, aclFloat16, float, 3, 1, 1, 1, 124, false, false, false>(
    aclFloat16* out, float* src, uint64_t* fbQuant, void* stream);
template void LaunchTStoreQuant<1, int8_t, int32_t, 2, 1, 2, 32, 32, false, true, false>(
    int8_t* out, int32_t* src, uint64_t* fbQuant, void* stream);
template void LaunchTStoreQuant<1, aclFloat16, float, 1, 1, 1, 16, 8, false, false, true>(
    aclFloat16* out, float* src, uint64_t* fbQuant, void* stream);
template void LaunchTStoreQuant<1, int16_t, int32_t, 2, 2, 2, 16, 16, false, false, false>(
    int16_t* out, int32_t* src, uint64_t* fbQuant, void* stream);
