...
template <typename T, int format, int srcShape0, int srcShape1, int srcShape2, int srcShape3, int srcShape4,
          int dstShape0, int dstShape1, int dstShape2, int dstShape3, int dstShape4, int groupN = 1>
void test_tstore()
{
    ...
    LaunchTStoreConv<T, format, srcShape0, srcShape1, srcShape2, srcShape3, srcShape4, dstShape0, dstShape1, dstShape2,
                     dstShape3, dstShape4, groupN>(dstDevice, srcDevice, stream);
...
TEST_F(TStoreConvTest, NDC1HWC0_1)
{
    test_tstore<float, 2, 1, 1, 1, 2, 8, 1, 1, 1, 2, 8, 1>();
}

TEST_F(TStoreConvTest, NDC1HWC0_2)
{
    test_tstore<float, 2, 3, 4, 1, 7, 8, 3, 4, 1, 7, 8, 2>();
}