...
TEST_F(TStoreMat2GMTest, case_nz1) { TestTStore<1, float, 1, 5, 21, 16, 8, 1, 5, 21, 16, 8>(); }

TEST_F(TStoreMat2GMTest, case_nz2) { TestTStore<1, int16_t, 2, 15, 11, 16, 16, 3, 23, 13, 16, 16>(); }

TEST_F(TStoreMat2GMTest, case_nz3) { TestTStore<1, int8_t, 1, 16, 32, 16, 32, 1, 32, 32, 16, 32>(); }

TEST_F(TStoreMat2GMTest, case_nz4) { TestTStore<1, uint16_t, 2, 4, 5, 16, 16, 7, 7, 7, 16, 16>(); }
