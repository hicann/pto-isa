...
def gen_golden_data(param):
    ...
    input_arr = np.random.randint(
        -5, 5, size=(g_whole_shape0, g_whole_shape1, g_whole_shape2, g_whole_shape3, g_whole_shape4)
    ).astype(data_type)
    output_arr = np.zeros(
        shape=(g_whole_shape0, g_whole_shape1, g_whole_shape2, g_whole_shape3, g_whole_shape4), dtype=data_type
    )
    output_arr[0:g_shape0, 0:g_shape1, 0:g_shape2, 0:g_shape3, 0:g_shape4] = input_arr[
        0:g_shape0, 0:g_shape1, 0:g_shape2, 0:g_shape3, 0:g_shape4
    ]
