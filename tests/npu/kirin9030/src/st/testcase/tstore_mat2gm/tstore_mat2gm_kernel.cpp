...
{
    TStoreKernel<
        T, format, gShape0, gShape1, gShape2, gShape3, gShape4, gWholeShape0, gWholeShape1, gWholeShape2, gWholeShape3,
...
template void LaunchTStore<1, float, 1, 5, 21, 16, 8, 1, 5, 21, 16, 8>(float* out, float* src, void* stream);
template void LaunchTStore<1, int16_t, 2, 15, 11, 16, 16, 3, 23, 13, 16, 16>(int16_t* out, int16_t* src, void* stream);
template void LaunchTStore<1, int8_t, 1, 16, 32, 16, 32, 1, 32, 32, 16, 32>(int8_t* out, int8_t* src, void* stream);
template void LaunchTStore<1, uint16_t, 2, 4, 5, 16, 16, 7, 7, 7, 16, 16>(uint16_t* out, uint16_t* src, void* stream);
