...
def gen_golden_data(g_info):
    ...
    if g_info.shape == DataFormat["NCHW2NC1HWC0"].value:
        # NCHW -> NC1HWC0
    ...
    elif g_info.shape == DataFormat["NC1HWC02C1HWN1N0C0"].value:
...
class TTRANSParams:
    def __init__(self, case_name, data_type, shape, g_shape0, g_shape1, g_shape2, g_shape3, g_shape4, g_shape5,
...
if __name__ == "__main__":
    ...
    case_params_list = [
        ...
        TTRANSParams("TTRANSConvTest.int32_1_8_1_8", np.int32, DataFormat["NCHW2NC1HWC0"].value,
                     1, 1, 1, 8, 8, 1, 1, 1, 8, 1, 8),
        ...
        TTRANSParams("TTRANSConvTest.int16_7_53_6_16", np.int16, DataFormat["NCHW2NC1HWC0"].value,
                     7, 4, 6, 16, 16, 1, 1, 7, 53, 6, 16),
        TTRANSParams("TTRANSConvTest.int8_3_64_2_64", np.int8, DataFormat["NCHW2NC1HWC0"].value,
                     3, 2, 2, 64, 32, 1, 1, 3, 64, 2, 64),
        TTRANSParams("TTRANSConvTest.int8_1_63_2_128", np.int8, DataFormat["NCHW2NC1HWC0"].value,
                     1, 2, 2, 128, 32, 1, 1, 1, 63, 2, 128),
        TTRANSParams("TTRANSConvTest.int8_5_58_2_16", np.int8, DataFormat["NCHW2NC1HWC0"].value,
                     5, 2, 2, 16, 32, 1, 1, 5, 58, 2, 16),
        TTRANSParams("TTRANSConvTest.uint8_9_87_6_16", np.uint8, DataFormat["NCHW2NC1HWC0"].value,
                     9, 3, 6, 16, 32, 1, 1, 9, 87, 6, 16),
        TTRANSParams("TTRANSConvTest.float32_1_32_6_48", np.float32, DataFormat["NCHW2NC1HWC0"].value,
                     1, 8, 6, 48, 4, 1, 1, 1, 32, 6, 48),
        TTRANSParams("TTRANSConvTest.uint16_1_26_2_16", np.uint16, DataFormat["NCHW2NC1HWC0"].value,
                     1, 7, 2, 16, 4, 1, 1, 1, 26, 2, 16),
        TTRANSParams("TTRANSConvTest.int8_5_18_2_16", np.int8, DataFormat["NCHW2NC1HWC0"].value,
                     5, 5, 2, 16, 4, 1, 1, 5, 18, 2, 16),
        # C1, H, W, N1, N0, C0 <- N, C1, H, W, C0
        TTRANSParams("TTRANSConvTest.float32_3_2_2_16_4", np.float32, DataFormat["NC1HWC02C1HWN1N0C0"].value,
                     2, 2, 16, 2, 2, 4, 3, 2, 2, 16, 4),
        TTRANSParams("TTRANSConvTest.int32_37_2_3_10_8", np.int32, DataFormat["NC1HWC02C1HWN1N0C0"].value,
                     2, 3, 10, 3, 16, 8, 37, 2, 3, 10, 8),
        TTRANSParams("TTRANSConvTest.float16_7_2_1_8_16", np.float16, DataFormat["NC1HWC02C1HWN1N0C0"].value,
                     2, 1, 8, 1, 16, 16, 7, 2, 1, 8, 16),
        TTRANSParams("TTRANSConvTest.float16_7_2_1_8_4", np.float16, DataFormat["NC1HWC02C1HWN1N0C0"].value,
                     2, 1, 8, 1, 16, 4, 7, 2, 1, 8, 4),
        TTRANSParams("TTRANSConvTest.uint16_45_3_2_7_16", np.uint16, DataFormat["NC1HWC02C1HWN1N0C0"].value,
                     3, 2, 7, 3, 16, 16, 45, 3, 2, 7, 16),
        TTRANSParams("TTRANSConvTest.int8_25_5_1_6_32", np.int8, DataFormat["NC1HWC02C1HWN1N0C0"].value,
                     5, 1, 6, 2, 16, 32, 25, 5, 1, 6, 32),
        TTRANSParams("TTRANSConvTest.uint8_11_2_7_7_32", np.uint8, DataFormat["NC1HWC02C1HWN1N0C0"].value,
                     2, 7, 7, 1, 16, 32, 11, 2, 7, 7, 32),
    ]
