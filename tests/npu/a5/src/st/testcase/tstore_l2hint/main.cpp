...
class TSTOREL2HintTest : public testing::Test {
protected:
    void SetUp() override {}
...
void tstore_l2hint_test()
{
    ...
    launchTSTORE<testKey>((uint8_t*)dstDevice, (uint8_t*)srcDevice, (uint64_t*)logDevice, stream);
...
TEST_F(TSTOREL2HintTest, case_vec_float_128x256_alloc_x5) { tstore_l2hint_test<1, float, 1>(); }

TEST_F(TSTOREL2HintTest, case_vec_float_128x256_notalloc_x5) { tstore_l2hint_test<2, float, 1>(); }
