...
TEST_F(TPARTSELTest, int8_tail) { test_tpartsel<int8_t, 4, 320, 3, 259>(); }
TEST_F(TPARTSELTest, uint8_tail) { test_tpartsel<uint8_t, 4, 320, 3, 259>(); }
TEST_F(TPARTSELTest, int64_tail) { test_tpartsel<int64_t, 4, 128, 3, 67>(); }
TEST_F(TPARTSELTest, uint64_tail) { test_tpartsel<uint64_t, 4, 128, 3, 67>(); }
