...
if __name__ == "__main__":
    ...
    case_params_list = [
        ...
        TConcatParams(np.float16, 16, 64, 16, 32, 16, 32, 16, 31, 32),
        TConcatParams(np.float32, 128, 64, 56, 32, 56, 32, 56, 32, 16),
        TConcatParams(np.int8, 128, 64, 56, 32, 56, 32, 56, 32, 16),
        TConcatParams(np.int8, 16, 64, 16, 32, 16, 32, 16, 31, 32),
        TConcatParams(np.int8, 32, 128, 32, 64, 32, 64, 32, 33, 31),
        TConcatParams(np.float32, 32, 128, 32, 64, 32, 64, 32, 33, 31),
    ]
