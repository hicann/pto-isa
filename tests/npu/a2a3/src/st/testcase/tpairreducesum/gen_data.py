...
if __name__ == "__main__":
    ...
    case_params_list = [
        TPairReduceSumParams(np.float32, 32, 128, 32, 128, 32, 128),
        TPairReduceSumParams(np.float32, 32, 64, 32, 64, 32, 64),
        TPairReduceSumParams(np.float16, 8, 256, 8, 256, 8, 256),
        TPairReduceSumParams(np.float16, 8, 64, 8, 128, 8, 64),
        TPairReduceSumParams(np.float32, 8, 32, 8, 64, 8, 32),
        TPairReduceSumParams(np.float16, 8, 64, 8, 128, 8, 63),
        TPairReduceSumParams(np.float32, 8, 32, 8, 64, 8, 31),
        TPairReduceSumParams(np.float16, 4, 128, 4, 128, 2, 106),
