...
TEST_F(TPAIRREDUCESUMTest, case_float_32x64_32x64_32x64)
{
    test_tpairreducesum<float, 32, 64, 32, 64, 32, 64>();
}
TEST_F(TPAIRREDUCESUMTest, case_float_32x128_32x128_32x128)
{
    test_tpairreducesum<float, 32, 128, 32, 128, 32, 128>();
}
TEST_F(TPAIRREDUCESUMTest, case_half_8x256_8x256_8x256)
{
    test_tpairreducesum<aclFloat16, 8, 256, 8, 256, 8, 256, true>();
}
TEST_F(TPAIRREDUCESUMTest, case_half_8x64_8x128_8x64)
{
    test_tpairreducesum<aclFloat16, 8, 64, 8, 128, 8, 64, true>();
}
TEST_F(TPAIRREDUCESUMTest, case_float_8x32_8x64_8x32)
{
    test_tpairreducesum<float, 8, 32, 8, 64, 8, 32>();
}
TEST_F(TPAIRREDUCESUMTest, case_half_8x64_8x128_8x63)
{
    test_tpairreducesum<aclFloat16, 8, 64, 8, 128, 8, 63, true>();
}
TEST_F(TPAIRREDUCESUMTest, case_float_8x32_8x64_8x31)
{
    test_tpairreducesum<float, 8, 32, 8, 64, 8, 31>();
}
TEST_F(TPAIRREDUCESUMTest, case_half_4x128_4x128_2x106)
{
    test_tpairreducesum<aclFloat16, 4, 128, 4, 128, 2, 106, true>();
}
TEST_F(TPAIRREDUCESUMTest, case_float_8x128_8x128_8x127)
{
    test_tpairreducesum<float, 8, 128, 8, 128, 8, 127>();
}
