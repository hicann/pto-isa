...
template void LaunchTRowArgMaxHalf<uint16_t, 1, 16, 16, 1, 1, 32768, 1, 768, 1, 32761>(aclFloat16 *outVal,
                                                                                       uint16_t *out, aclFloat16 *src,
                                                                                       void *stream);
template void LaunchTRowArgMaxHalf<uint32_t, 16, 1, 16, 1, 2, 4096, 2, 1536, 2, 4096>(aclFloat16 *outVal, uint32_t *out,
                                                                                      aclFloat16 *src, void *stream);
template void LaunchTRowArgMaxHalf<uint32_t, 16, 1, 16, 1, 1, 65552, 1, 1536, 1, 65552>(aclFloat16 *outVal,
                                                                                        uint32_t *out, aclFloat16 *src,
                                                                                        void *stream);
template void LaunchTRowArgMaxHalf<uint32_t, 272, 1, 272, 1, 272, 112, 272, 16, 272, 112>(aclFloat16 *outVal,
                                                                                          uint32_t *out,
                                                                                          aclFloat16 *src,
                                                                                          void *stream);
template void LaunchTRowArgMaxHalf<uint32_t, 272, 16, 272, 8, 272, 112, 272, 16, 272, 112>(aclFloat16 *outVal,
                                                                                           uint32_t *out,
                                                                                           aclFloat16 *src,
                                                                                           void *stream);
