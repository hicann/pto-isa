...
class TLOADL2HintTest : public testing::Test {
protected:
    void SetUp() override {}
...
TEST_F(TLOADL2HintTest, case_vec_float_128x256_alloc_x5) { tload_l2hint_test<1, float, 1>(); }

TEST_F(TLOADL2HintTest, case_vec_float_128x256_notalloc_x5) { tload_l2hint_test<2, float, 1>(); }
