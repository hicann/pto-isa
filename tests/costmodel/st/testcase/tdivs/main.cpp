...
TEST(TDivS, case3_tile_scalar_int32_31x128) { runTDivS_TileScalar<int32_t, 31, 31, 128, 128, 126.0f, 1.0f>(1); }
TEST(TDivS, case4_tile_scalar_int16_15x192) { runTDivS_TileScalar<int16_t, 15, 15, 192, 192, 92.0f, 1.0f>(1); }
...
TEST(TDivS, case7_scalar_tile_int32_31x128) { runTDivS_ScalarTile<int32_t, 31, 31, 128, 128, 126.0f, 1.0f>(1); }
TEST(TDivS, case8_scalar_tile_int16_15x192) { runTDivS_ScalarTile<int16_t, 15, 15, 192, 192, 92.0f, 1.0f>(1); }
