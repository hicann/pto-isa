    ...
    unsigned validRow, unsigned validCol)
{
    ...
    if constexpr (
        TileDataDst::SFractal == SLayout::NoneBox && TileDataSrc0::SFractal == SLayout::NoneBox &&
        TileDataSrc1::SFractal == SLayout::NoneBox && TileDataDst::isRowMajor && TileDataSrc0::isRowMajor &&
        TileDataSrc1::isRowMajor) {
