...
PTO_INTERNAL void TTriCheck(const TileData& dst)
{
    ...
    static_assert(
        std::is_same<T, int32_t>::value || std::is_same<T, int>::value || std::is_same<T, int16_t>::value ||
            std::is_same<T, int64_t>::value || std::is_same<T, uint32_t>::value || std::is_same<T, uint16_t>::value ||
            std::is_same<T, uint64_t>::value || std::is_same<T, half>::value || std::is_same<T, bfloat16_t>::value ||
