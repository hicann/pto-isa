...
- 代码符合`.clang-format`和`pyproject.toml`规范，提交前请使用命令`clang-format -i -style=file <文件名>`和`ruff format <文件名>`修复代码规范问题
- PR 是否已关联对应 Issue
- 是否签署 CLA
...
python3 tests/run_cpu.py --testcase tadd --gtest_filter 'TADDTest.case_float_64x64_64x64' --generator Ninja --build-dir build/cpu_smoke_tadd --clean
