...
<!-- md-trans-meta sourceCommit=unknown translatedAt=2026-08-26T03:46:41.082Z pushedAt=2026-08-29T09:05:18.423Z -->
...
Column-broadcast multiplication: multiplies each column by a per-column scalar vector.
...
- `TileDataDst::DType` and `TileDataSrc1::DType` must be one of the following: `half`, `float`, `int16`, `int32` (applicable to Atlas A2/A3 training products/Atlas A2/A3 inference products and Ascend 950PR/Ascend 950DT); `uint16`, `uint32`, `bfloat16_t`, `int8`, `uint8` (applicable only to Ascend 950PR/Ascend 950DT).
